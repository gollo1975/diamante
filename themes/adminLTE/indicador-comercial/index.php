...
$this->title = 'INDICADOR COMERCIAL';
...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute("indicador-comercial/index"),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="filtropedido" style="display:none">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute("indicador-comercial/index") ?>" class="btn btn-primary"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
<?php $formulario->end() ?>
    ...
    <div class="panel-heading">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tr style="font-size: 90%;">  
                    ...
                    <?php }else{?>   
                        <td style= 'width: 25px; height: 25px;'>    
                            <?= Html::a('<span class="glyphicon glyphicon-user"></span> ', ['carga_vendedores', 'id' => $val->id_indicador, 'desde' =>$val->fecha_inicio, 'hasta' => $val->fecha_cierre], [
                                          'class' => '',
                                          'data' => [
                                              'confirm' => 'Esta seguro de cargar los vendedores que hicieron gestion comercial ?',
                                              'method' => 'post',
                                          ],
                                      ])?>
                        </td>   
            ...
            <?php endforeach; ?>
                ...
                <div class="panel-footer text-right" >            
                   <?= Html::a('<span class="glyphicon glyphicon-plus"></span> Crear mes',
                       ['/indicador-comercial/crear_cierre_mes'],
                         ['title' => 'Permite Crear el cierre mensual',
                          'data-toggle'=>'modal',
                          'data-target'=>'#modalcrearcierremes',
                          'class' => 'btn btn-success btn-xs'
                         ])    
                   ?>
                   <div class="modal remote fade" id="modalcrearcierremes">
