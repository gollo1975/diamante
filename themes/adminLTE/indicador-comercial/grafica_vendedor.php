...
<script type="text/javascript">
     ...
     var visita =  <?php echo $visita; ?>; 
     var reales = <?php echo $visita_real;?>;    
     var noreales = <?php echo $novisita;?>; 
     var eficiencia = <?php echo $eficiencia;?>; 
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'INDICADOR DE EFICIENCIA PARA VENDEDORES'
    },
    xAxis: {
        categories: ['Visitas', 'Visitas reales', 'No visitas', 'Eficiencia']
    },
    yAxis: {
        min: 0,
        title: {
    ...
    series: [{
        name: 'Total visitas',
        data: [visita, reales, noreales, eficiencia]
    }, {
        name: 'Visitas reales',
        data: [reales]
    }, {
        name: 'Visitas faltantes',
        data: [noreales]
    }, {
        name: 'Porcentaje',
        data: [eficiencia]    
