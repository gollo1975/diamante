...
?>
     <div class="btn-group btn-sm" role="group">
          <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Regresar', ['view','id' => $model->id_recibo, 'token' => $token], ['class' => 'btn btn-primary btn-sm']) ?>
...
<div class="panel panel-success">
    <div class="panel-body">
        ...
        <?php $formulario = ActiveForm::begin([
            "method" => "get",
            "action" => Url::toRoute(["recibo-caja/buscar_facturas_admon", 'id' => $id, 'token' => $token,'id_cliente' => $id_cliente]),
        ...
        <div class="panel panel-success panel-filters">
            ...
            <div class="panel-body" id="filtro" style="display:none">
                ...
                <div class="panel-footer text-right">
                    ...
                    <a align="right" href="<?= Url::toRoute(["recibo-caja/buscar_facturas_admon", 'id' => $id, 'token' => $token,'id_cliente' => $id_cliente]) ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
                </div>
            </div>
        </div>
        <?php $formulario->end() ?>
                    ...
                    <div class="table-responsive">
                        <div class="panel panel-success">
                           <div class="panel-body">
                            ...
                            <div class="panel-footer text-right">
                               <?= Html::submitButton("<span class='glyphicon glyphicon-floppy-disk'></span> Enviar", ["class" => "btn btn-success btn-sm", 'name' => 'enviar_factura_admon']) ?>
                            </div>
                        </div>
