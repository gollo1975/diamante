...
//Modelos...
$this->title = 'CONSULTA PRODUCTO VENDIDO (Factura)';
...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute("factura-venta-punto/search_producto_vendido"),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="filtro" style="display:block">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute("factura-venta-punto/search_producto_vendido") ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
                    ...
                    foreach ($model as $val):
                        ...
                        <tr style ='font-size: 90%;'>  
                            ...
                            <td style= 'width: 25px; height: 10px;'>
                                 <a href="<?= Url::toRoute(["factura-venta-punto/view_consulta", "id_factura_punto" => $val->id_factura,'token' => 2]) ?>" ><span class="glyphicon glyphicon-eye-open" title="Permite crear las cantidades del producto, lote y codigos"></span></a>
                            </td> 
                        </tr>            
                    <?php 
                    endforeach;
