...
$puntoVenta = ArrayHelper::map(PuntoVenta::find()->orderBy('nombre_punto ASC')->all(), 'id_punto', 'nombre_punto');
?>
...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute(["factura-venta-punto/search_maestro_factura",'token' => $token]),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="filtrocliente" style="display:block">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute(["factura-venta-punto/search_maestro_factura",'token' => $token]) ?>" class="btn btn-primary"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
                ...
                foreach ($model as $val): ?>
                    <tr style="font-size: 90%;">
                       ...
                       <td style= 'width: 20px; height: 20px;'>
                            <a href="<?= Url::toRoute(["factura-venta-punto/view_consulta", "id_factura_punto" => $val->id_factura, 'token' => $token]) ?>" ><span class="glyphicon glyphicon-eye-open" title="Permite ver del detalle factura de venta"></span></a>
                        </td>
                        <td style= 'width: 20px; height: 20px;'>
                            <a href="<?= Url::toRoute(["factura-venta-punto/imprimir_factura_venta", "id_factura_punto" => $val->id_factura]) ?>" ><span class="glyphicon glyphicon-print" title="Permite imprimir la factura de venta"></span></a>
                        </td>
                    </tr>
                <?php endforeach;
                ?>
