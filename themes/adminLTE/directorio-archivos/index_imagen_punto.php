    ...
    <div class="panel-heading">
        ...
        <div class="panel-footer text-right" >
            <?php if($token == 0){?>
                ...
                <?= Html::a('<span class="glyphicon glyphicon-upload"></span> Subir Archivo', ['directorio-archivos/subir_archivo_puntoventa','numero' => $numero, 'codigo' => $codigo,'validador_imagen' =>$validador_imagen, 'token' => $token], ['class' => 'btn btn-success btn-sm']); ?>            
            <?php }else{?>
               <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Regresar', [$validador_imagen.'/validador_imagen', 'id' => $codigo, 'token' => $token], ['class' => 'btn btn-primary btn-sm']); ?>
            <?php }?>
        </div>
