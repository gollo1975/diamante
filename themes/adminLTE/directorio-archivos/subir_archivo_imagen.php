...
<?php $form = ActiveForm::begin([
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <?= $form->field($model, 'validador_imagen')->input("hidden") ?>
            </div>
            <div class="row">
            ...
            <div class="panel-footer text-right">                
                <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Regresar', ['directorio-archivos/index_imagen_punto', 'numero' => $model->numero,'codigo' => $model->codigo,'validador_imagen' => $validador_imagen, 'token' => $token], ['class' => 'btn btn-primary btn-sm']); ?>
