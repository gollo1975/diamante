    ...
    <div class="panel-heading">
        ...
        <table class="table table-bordered table-hover">
            ...
            foreach ($model as $val): 
                                            ...
                                            <div class="modal-body">
                                                <div class="panel panel-success">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <input type="hidden" name="view_archivo" value="<?= $view_archivo ?>">
                                                    </div>
                                                </div>
                                            </div>
                ...
                <td style= 'width: 20px; height: 20px;'>
                    <?php if($token == 0){?>
                      <a href="<?= Url::toRoute(["directorio-archivos/borrar_archivo", "id" => $val->idarchivodir, 'numero' => $numero, 'codigo' => $codigo,'view_archivo' => $view_archivo, 'token' => $token]) ?>" ><span class="glyphicon glyphicon-remove"></span></a>
                    <?php }?>
                </td>
            </tr>
            </tbody>
