    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <div class="panel-footer text-right">                
                <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Regresar', ['directorio-archivos/index', 'numero' => $model->numero,'codigo' => $model->codigo,'view' => $view, 'token' => $token], ['class' => 'btn btn-primary btn-sm']); ?>
