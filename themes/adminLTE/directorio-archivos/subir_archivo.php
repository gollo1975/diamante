...
<?php $form = ActiveForm::begin([
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <?= $form->field($model, 'view_archivo')->input("hidden") ?>
            </div>
            <div class="row">
            ...
            <div class="panel-footer text-right">                
                <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Regresar', ['directorio-archivos/index_archivo', 'numero' => $model->numero,'codigo' => $model->codigo,'view_archivo' => $view_archivo, 'token' => $token], ['class' => 'btn btn-primary btn-sm']); ?>
