   ...
   <!--<h1><?= Html::encode($this->title) ?></h1>-->
    ...
    if($model->estado_generado == 0){?>
        <p>
           ...
           <?= Html::a('<span class="glyphicon glyphicon-export"></span> Generar conceptos', ['generar_conceptos', 'id' => $model->id_prestacion, 'pagina' =>$pagina], ['class' => 'btn btn-info btn-xs']) ?>
       </p>
    <?php }else{
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped table-hover">
                <tr style='font-size:85%;'>
                    ...
                    <td><?= Html::encode(mb_strtoupper($model->empleado->nombre_completo)) ?></td>
                 ...
                 <tr style='font-size:85%;'>
                    ...
                    <td><?= Html::encode($model->contrato->cargo->nombre_cargo) ?></td>  
                ...
                <tr style='font-size:85%;'>
                 ...
                 <tr style='font-size:85%;'>
                    ...
                    <td><?= Html::encode($model->empleado->banco->entidad) ?></td>
            ...
            <div role="tabpanel" class="tab-pane active" id="detalleprestacion">
                ...
                if($model->estado_aplicado == 0){?>
                    <div class="panel-footer text-right"> 
                        ...
                        <?= Html::submitButton("<span class='glyphicon glyphicon-send'></span> Actualizar lineas", ["class" => "btn btn-success btn-sm", 'name' => 'crear_prestaciones']) ?>
                    </div>
                <?php }else{ ?>
                     <div class="panel-footer text-right"> 
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered table-hover">
                                <thead >
                                    <tr style='font-size:85%;'>
                                        <th scope="col" align="center" style='background-color:#B9D5CE;'><b>Id</b></th>  
                                        <th scope="col" align="center" style='background-color:#B9D5CE;'><b>Codigo nomina</b></th>
                                        <th scope="col" align="center" style='background-color:#B9D5CE;'><b>Concepto</b></th>                        
