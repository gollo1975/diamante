        ...
        <div class="table table-responsive">
            <div class="panel panel-success ">
                <div class="panel-heading" style="text-align: left ">
                  NUEVA CITA PROSPECTO    
                </div>
                <div class="panel-body">
                    <div class="row">
                        <?= $form->field($model, 'tipo_visita')->dropdownList($tipovisita, ['prompt' => 'Seleccione...', 'required' => 'true']) ?>
                    </div>
                    <div class="row">
                        <?= $form->field($model, 'hora_visita')->input ('time',['required' => 'true'])?>
                    </div>
                    <div class="row">
                    ...
                    <div class="panel-footer text-right">
                       <?= Html::submitButton("<span class='glyphicon glyphicon-floppy-disk'></span> Enviar", ["class" => "btn btn-primary", 'name' => 'nueva_cita_prospecto']) ?>                    
                   </div>
