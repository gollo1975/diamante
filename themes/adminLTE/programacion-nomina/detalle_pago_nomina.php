...
$this->params['breadcrumbs'][] = ['label' => 'Comprobante de pago', 'url' => ['search_comprobante_nomina']];
$this->params['breadcrumbs'][] = $model->id_programacion;
?>

<div class="programacion-nomina-detalle_pago_nomina">

    <!--<h1><?= Html::encode($this->title) ?></h1>-->
    <p>
        <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Regresar', ['search_comprobante_nomina'], ['class' => 'btn btn-primary btn-sm']) ?>
        <?= Html::a('<span class="glyphicon glyphicon-print"></span> Imprimir', ['imprimir_colilla_pago', 'id' => $model->id_programacion], ['class' => 'btn btn-default btn-sm']) ?>
    </p>
    <?php
         ...
         $banco = app\models\BancoEmpleado::find()->where(['=','id_banco', $empleado->id_banco])->one();
    ?>
            ...
            <table class="table table-bordered table-striped table-hover" WIDTH="80%">
                ...
                <tr style ='font-size:85%;'>
                 ...
                 <tr style ='font-size:85%;'>
                    ...
                    <td><?= Html::encode($model->contrato->id_tipo_salario) ?></td>
                 ...
                 <tr style ='font-size:85%;'>
                    ...
                    <td  colspan="3"><?= Html::encode($banco->entidad) ?></td>
                    ...
                    <td><?= Html::encode($empleado->numero_cuenta) ?></td>
