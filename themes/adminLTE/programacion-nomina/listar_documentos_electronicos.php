...
$grupoPago = ArrayHelper::map(app\models\GrupoPago::find()->all(), 'id_grupo_pago', 'grupo_pago')
?>
...
<?php if(count($model) > 0){?>  
    <div class="panel-footer text-left" >  
            <?= Html::submitButton("<span class='glyphicon glyphicon-send'></span> Enviar documentos a la dian",
                ['name' => 'enviar_documento_electronico', "class" => "btn btn-info btn-sm",
                    'data' => [
                     'confirm' => 'Esta seguro de ENVIAR a la DIAN la nomima electronica seleccionada.', 'method' => 'post', 
                    ]
            ])?>
    </div>
<?php }?>
