 ...
 <!--<h1><?= Html::encode($this->title) ?></h1>-->
       ...
       if($model->estado_periodo == 0){?>
            <div class="btn-group" role="group" aria-label="...">
                <button type="button" class="btn btn-default btn-xs"> <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Regresar', ['index'],['class' => 'btn btn-primary btn-xs']) ?></button>
                <button type="button" class="btn btn-default btn-xs"><?= Html::a('<span class="glyphicon glyphicon-export"></span> Cargar Empleados', ['cargar', 'id' => $model->id_periodo_pago_nomina, 'tipo_nomina' => $model->id_tipo_nomina , 'id_grupo_pago' =>$model->id_grupo_pago, 'fecha_desde' => $model->fecha_desde, 'fecha_hasta' =>$model->fecha_hasta], ['class' => 'btn btn-default btn-xs']) ?></button>
                <button type="button" class="btn btn-default btn-xs"><?= Html::a('<span class="glyphicon glyphicon-plus"></span> Agregar Empleado', ['agregarempleado', 'id' => $model->id_periodo_pago_nomina, 'tipo_nomina' => $model->id_tipo_nomina , 'id_grupo_pago' =>$model->id_grupo_pago, 'fecha_desde' => $model->fecha_desde, 'fecha_hasta' =>$model->fecha_hasta], ['class' => 'btn btn-green btn-xs']) ?></button>
                    ...
                    <div class="panel-footer text-right">
                        ...
                        <div class="btn-group">
                            <button type="button" class="btn btn-danger btn-xs dropdown-toggle"
                                    data-toggle="dropdown">
                                <span class="glyphicon glyphicon-export"></span> Eliminar
                            </button>
                            <ul class="dropdown-menu" role="menu">
