...
$empleado = ArrayHelper::map(Empleados::find()->where(['=','estado', 0])->orderBy('nombre_completo ASC')->all(), 'id_empleado', 'nombre_completo');
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    'pluginOptions' => [
                        'allowClear' => true ]]);
                    ?>
                     <?= $form->field($model, 'valor_credito')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="row">
                    ...
                    <div class="panel-body">
                        <div class="checkbox checkbox-success" align ="right">
                                <?= $form->field($model, 'aplicar_prima')->checkBox(['label' => 'Prima semestral','1' =>'small', 'class'=>'bs_switch','style'=>'margin-bottom:5px;', 'id'=>'aplicar_prima']) ?>
                                 <?= $form->field($model, 'valor_aplicar')->textInput(['maxlength' => true]) ?>
                     </div>
                </div>   
