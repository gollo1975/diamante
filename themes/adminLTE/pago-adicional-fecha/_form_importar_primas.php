...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute(["pago-adicional-fecha/importar_primas", 'id' => $id, 'fecha_corte' => $fecha_corte]),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="buscarmaquina">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute(["pago-adicional-fecha/importar_primas", 'id' => $id, 'fecha_corte' => $fecha_corte]) ?>" class="btn btn-primary"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
...
<div class="table table-responsive">
    <div class="panel panel-success ">
        <div class="panel-heading">
            Registros : <span class="badge"><?= count($nominas) ?> </span>
        </div>
        <div class="panel-body">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th scope="col" style='background-color:#B9D5CE;'>Valor Prima</th>
                    <th scope="col" style='background-color:#B9D5CE;'>Grupo pago</th>                    
                    <th scope="col" style='background-color:#B9D5CE;'><input type="checkbox" onclick="marcar(this);"/></th>
                </tr>
                </thead>
                <tbody>
                <?php foreach ($nominas as $val): ?>
                    ...
                    <td style="width: 30px;"><input type="checkbox" name="id_programacion[]" value="<?= $val->id_programacion ?>"></td>
                </tr>
                </tbody>
                <?php endforeach; ?>
            </table>
        ...
        <div class="panel-footer text-right">
            ...
            <?= Html::submitButton("<span class='glyphicon glyphicon-send'></span> Enviar", ["class" => "btn btn-success btn-sm", 'name' => 'enviar_registros']) ?>
        </div>
