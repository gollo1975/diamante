...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute(["pago-adicional-fecha/importar_intereses", 'id' => $id, 'fecha_corte' => $fecha_corte]),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="buscarmaquina">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute(["pago-adicional-fecha/importar_intereses", 'id' => $id, 'fecha_corte' => $fecha_corte]) ?>" class="btn btn-primary"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
