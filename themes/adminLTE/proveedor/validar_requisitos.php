        ...
        <div class="table table-responsive">
            <div class="panel panel-success ">
                ...
                <div class="panel-body">
                    <div class="row">
                         <?= $form->field($modelo, 'documento')->input("text", ["maxlength" => 15, 'required' => true]) ?>
                    </div>
                </div>  
                    <div class="panel-footer text-right">
                       <?= Html::submitButton("<span class='glyphicon glyphicon-search'></span> Buscar", ["class" => "btn btn-primary", 'name' => 'validar']) ?>                    
                   </div>
