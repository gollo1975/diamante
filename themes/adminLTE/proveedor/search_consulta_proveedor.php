...
$this->title = 'CONSULTA (Proveedores)';
...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute("proveedor/search_consulta_proveedor"),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="filtroproveedor" style="display:none">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute("proveedor/search_consulta_proveedor") ?>" class="btn btn-primary"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
