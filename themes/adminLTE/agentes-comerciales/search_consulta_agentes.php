...
$this->title = 'CONSULTA (Agentes comerciales)';
...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute("agentes-comerciales/search_consulta_agentes"),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="filtroagentecomercial" style="display:none">
        <div class="row" >
            ...
            <?= $formulario->field($form, 'cargo')->widget(Select2::classname(), [
                'data' => $cargo,
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute("agentes-comerciales/search_consulta_agentes") ?>" class="btn btn-primary"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
           ...
           <tr style="font-size: 90%;">    
            ...
            <tr style="font-size: 90%;">
                ...
                <?php }else{?>
                    ...
                    <td style='background-color:#CEECD4;'><?= $val->tipoDocumento->tipo_documento ?></td>
                    ...
                    <td style='background-color:#CEECD4;'><?= $val->email_agente ?></td>
                     <td style='background-color:#CEECD4;'><?= $val->cargo->nombre_cargo ?></td>
                    <td style='background-color:#CEECD4;'><?= $val->codigoDepartamento->departamento ?></td>
                    <td style='background-color:#CEECD4;'><?= $val->codigoMunicipio->municipio ?></td>
                <?php }?>    
                <td style= 'width: 25px; height: 20px;'>
                    <a href="<?= Url::toRoute(["agentes-comerciales/view", "id" => $val->id_agente, 'token' => $token]) ?>" ><span class="glyphicon glyphicon-eye-open"></span></a>
                </td>
            </tr>
            </tbody>
            <?php endforeach; ?>
