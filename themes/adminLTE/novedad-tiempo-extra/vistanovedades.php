                                ...
                                <tbody>
                                    <?php foreach ($detalle as $val): ?>
                                        <tr style='font-size: 85%;'>
                                            ...
                                            <?php
                                               if($val->contrato->id_tipo_salario == 2){?>
                                                    <td style="width: 20px; height: 20px">
                                                        <?= Html::a('<span class="glyphicon glyphicon-book"></span>',            
                                                        ['/novedad-tiempo-extra/creartiempoextra','id' => $val->id_periodo_pago_nomina, 'id_programacion'=>$val->id_programacion, 'tipo_salario' => $val->contrato->id_tipo_salario],
                                                            [
                            ...
                            <table class="table table-bordered table-hover">
                                <thead>
                                    <tr style='font-size: 85%;'>
                                        ...
                                        <th scope="col" style='background-color:#B9D5CE;'>% Hora</th>       
