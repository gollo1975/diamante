...
<div class="panel panel-success">
    ...
    <div class="panel-body">
        <div class="row">
            <?= $form->field($model, 'id_proveedor')->dropDownList($proveedor,['prompt'=>'Seleccione un proveedor...', 'onchange'=>' $.get( "'.Url::toRoute('entrada-productos-inventario/ordencompra').'", { id: $(this).val() } ) .done(function( data ) {
