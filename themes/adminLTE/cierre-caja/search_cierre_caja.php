...
$this->title = 'CONSULTA DE CIERRE DE CAJA';
$this->params['breadcrumbs'][] = $this->title;

$conPunto = ArrayHelper::map(app\models\PuntoVenta::find()->where(['<>','id_punto', 1])->orderBy('nombre_punto ASC')->all(), 'id_punto', 'nombre_punto');
?>
<script language="JavaScript">
    function mostrarfiltro() {
        divC = document.getElementById("filtrocierrecaja");
...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute("cierre-caja/search_cierre_caja"),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="filtrocierrecaja" style="display:block">
        <div class="row" >
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute("cierre-caja/search_cierre_caja") ?>" class="btn btn-primary"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
            ...
            <tr style="font-size: 90%;">                   
               ...
               <td style="text-align: right"><?= ''.number_format($val->total_cierre_caja,0) ?></td>
                ...
                <td style= 'width: 25px; height: 20px;'>
                    <a href="<?= Url::toRoute(["cierre-caja/view_search", "id" => $val->id_cierre]) ?>" ><span class="glyphicon glyphicon-eye-open"></span></a>
                </td>
            </tr>
            </tbody>
            <?php endforeach; ?>
