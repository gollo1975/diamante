...
$this->title = 'CONSULTA (Solicitud de compras)';
...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute("solicitud-compra/search_consulta_solicitud_compra"),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="filtro" style="display:none">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute("solicitud-compra/search_consulta_solicitud_compra") ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
