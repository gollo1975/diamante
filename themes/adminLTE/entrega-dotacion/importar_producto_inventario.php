...
$this->params['breadcrumbs'][] = ['label' => 'Entrega de dotacion', 'url' => ['view', 'id' => $id, 'token' => $token]];
...
?>
    <div class="modal-body">
        ...
        <?php $formulario = ActiveForm::begin([
            "method" => "get",
            "action" => Url::toRoute(["entrega-dotacion/buscar_producto_inventario", 'id' => $id, 'token' => $token]),
            ...
            <div class="panel-body" id="filtrocliente">
                ...
                <div class="panel-footer text-right">
                    <?= Html::submitButton("<span class='glyphicon glyphicon-search'></span> Buscar", ["class" => "btn btn-primary btn-sm",]) ?>
                     <a align="right" href="<?= Url::toRoute(["entrega-dotacion/buscar_producto_inventario", 'id' => $id, 'token' => $token]) ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
                </div>
            </div>
        </div>
