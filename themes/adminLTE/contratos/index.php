...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute("contratos/index"),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="filtrocliente" style="display:none">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute("contratos/index") ?>" class="btn btn-primary"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
            ...
            <tbody>
                ...
                foreach ($model as $val): ?>
                    <tr style="font-size: 90%;">                   
                        ...
                        <td style= 'width: 25px; height: 20px;'>
                            <a href="<?= Url::toRoute(["contratos/update", "id" => $val->id_contrato, 'sw' => 1])?>" ><span class="glyphicon glyphicon-pencil"></span></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>        
