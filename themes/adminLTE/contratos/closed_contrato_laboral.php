            ...
            <div class="panel panel-success ">
                ...
                <div class="panel-body">
                   ...
                   <div class="checkbox checkbox-success" align ="center">  
                        <?= $form->field($model, 'generar_liquidacion')->checkBox(['label' => 'generar_liquidacion',''=>'small', 'checked' => 'true', 'class'=>'bs_switch','style'=>'margin-bottom:5px;', 'id'=>'generar_liquidacion']) ?> 
                        
                    </div>     
                </div>                
                <div class="panel-footer text-right">			
                    <?= Html::submitButton("<span class='glyphicon glyphicon-floppy-disk'></span> Actualizar", ["class" => "btn btn-primary", 'name' => 'cerrar_contrato']) ?>                    
                </div>
            </div>
        </div>
    </div>
