...
$this->title = 'PRORROGAS DEL CONTRATO';
...
?>
        <div class="panel panel-success">
            <div class="panel-heading">
                Información de la prorrogas al contrato
            </div>
            <div class="panel-body">
                ...
                <div class="panel-footer text-right">			
                    <a href="<?= Url::toRoute(['contratos/view', 'id' => $id]) ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-circle-arrow-left'></span> Regresar</a>
