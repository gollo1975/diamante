...
?>
        <div class="panel panel-success">
            <div class="panel-heading">
                Información de la Adicion al contrato
            </div>
            <div class="panel-body">
                ...
                <div class="row">
                        ...
                        $form->field($modeloadicion, 'fecha_aplicacion')->widget(DatePicker::className(), ['name' => 'check_issue_date',
                            ...
                            'pluginOptions' => [
                                ...
                                'todayHighlight' => true]])
                        ?>  
                         <?= $form->field($modeloadicion, 'valor_adicion')->textInput(['maxlength' => true]) ?>
                    </div>  
                <div class="row">
                ...
                <div class="panel-footer text-right">			
                    <a href="<?= Url::toRoute(['contratos/view', 'id' => $id, 'token' => $token]) ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-circle-arrow-left'></span> Regresar</a>
