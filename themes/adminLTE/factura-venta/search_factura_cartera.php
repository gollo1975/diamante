...
$this->title = 'CONSULTA (Facturas x pagar)';
    ...
    <div class="panel-heading">
        ...
        <table class="table table-bordered table-hover">
           ...
           <tr style="font-size: 90%;">    
                ...
                <th scope="col" style='background-color:#B9D5CE;'><span title="Dias de mora factura">D. mora</span></th>
                ...
                foreach ($model as $val): ?>
                    <tr style="font-size: 90%;">
                        ...
                        <td style= 'width: 25px; right: 25px;'>
                            <a href="<?= Url::toRoute(["factura-venta/view_consulta", "id" => $val->id_factura]) ?>" ><span class="glyphicon glyphicon-eye-open" title="Permite ver la vista de la factura y el detalle"></span></a>
                        </td>     
                    </tr>
                <?php endforeach;?>
            </tbody>        
