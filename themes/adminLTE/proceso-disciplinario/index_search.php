...
$this->title = 'PROCESOS DISCIPLINARIOS';
...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute("proceso-disciplinario/index_search"),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="filtroproceso" style="display:none">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute("proceso-disciplinario/index_search") ?>" class="btn btn-primary"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
