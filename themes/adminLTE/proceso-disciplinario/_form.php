...
$conEmpleado = ArrayHelper::map(\app\models\Empleados::find()->where(['=','estado', 0])->orderBy('nombre_completo ASC')->all(), 'id_empleado', 'nombre_completo');
...
$departamento = ArrayHelper::map(app\models\Departamentos::find()->orderBy('departamento ASC')->all(), 'codigo_departamento', 'departamento');
$municipio = ArrayHelper::map(app\models\Municipios::find()->orderBy('municipio DESC')->all(), 'codigo_municipio', 'municipio');
?>
