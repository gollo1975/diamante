...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute("pedidos/search_pedido_vendedor"),
...
$cliente = ArrayHelper::map(Clientes::find()->where(['=','id_agente', $documento_vendedor->id_agente])
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="filtropedido" style="display:block">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute("pedidos/search_pedido_vendedor") ?>" class="btn btn-primary"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
<?php $formulario->end() ?>
    ...
    <div class="panel panel-success ">
        ...
        <thead>
            <tr style="font-size: 90%;">   
                ...
                <th scope="col" style='background-color:#B9D5CE;'>Vlr. Presupuesto</th>
        ...
        <div class="panel-footer text-right">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><?= Html::submitButton("<span class='glyphicon glyphicon-export'></span> Excel", ['name' => 'excel']); ?></li>
