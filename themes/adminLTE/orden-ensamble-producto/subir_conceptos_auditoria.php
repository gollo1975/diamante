...
$conForma = ArrayHelper::map(app\models\FormaCosmetica::find()->all(), 'id_forma', 'concepto');
?>
<?php
        ...
        <div class="table table-responsive">
            <div class="panel panel-success ">
                <div class="panel-heading" style="text-align: left ">
                  SUBIR INFORMACION DE AUDITORIA  
                </div>
                <div class="panel-body">
                    <div class="row">
                         <?= $form->field($model, 'cosmetica')->dropdownList($conForma, ['prompt' => 'Seleccione...']) ?>
                    </div>
                    <div class="row">
