...
$this->params['breadcrumbs'][] = ['label' => 'Inventario material de empaque', 'url' => ['/orden-ensamble-producto/view', 'id' => $id, 'token' => $token ]];
$this->params['breadcrumbs'][] = $id;
?>
    <div class="modal-body">
        <p>
            <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Regresar', ['/orden-ensamble-producto/view', 'id' => $id, 'token' => $token], ['class' => 'btn btn-primary btn-sm']) ?>
        </p>
        
        <?php $formulario = ActiveForm::begin([
            "method" => "get",
            "action" => Url::toRoute(["orden-ensamble-producto/buscar_material_empaque", 'id' => $id, 'token' => $token, 'id_solicitud' => $id_solicitud]),
        ...
        <div class="panel panel-success panel-filters">
            ...
            <div class="panel-body" id="filtrocliente">
                ...
                <div class="panel-footer text-right">
                    ...
                    <a align="right" href="<?= Url::toRoute(["orden-ensamble-producto/buscar_material_empaque", 'id' => $id, 'token' => $token, 'id_solicitud' => $id_solicitud]) ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
                </div>
            </div>
        </div>
