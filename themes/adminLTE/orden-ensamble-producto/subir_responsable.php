        ...
        <div class="table table-responsive">
            <div class="panel panel-success ">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                          <?= $form->field($model, 'peso_neto')->input(['text', 'maxlength' => true]) ?>
                    </div>
                    <div class="row">
                    ...
                    <div class="panel-footer text-right">
                       <?= Html::submitButton("<span class='glyphicon glyphicon-send'></span> Enviar", ["class" => "btn btn-primary", 'name' => 'subir_responsable']) ?>                    
                   </div>
