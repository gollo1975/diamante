...
$this->title = 'CONSULTA (PROGRAMACION DE CITAS)';
...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute("programacion-citas/search_programacion_citas"),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="filtropedido" style="display:none">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute("programacion-citas/search_programacion_citas") ?>" class="btn btn-primary"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
<?php $formulario->end() ?>
            ...
            <tr style="font-size: 90%;">  
                <td><?= $val->id_programacion ?></td>
                 ...
                 <td style= 'width: 25px; height: 25px;'>
                     <a href="<?= Url::toRoute(["programacion-citas/view_search_programacion", "id" => $val->id_programacion]) ?>" ><span class="glyphicon glyphicon-eye-open"></span></a>
                 </td>
            </tr>
            <?php endforeach; ?>
            </tbody>
