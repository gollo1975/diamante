...
<div class="almacenamiento-producto-view_almacenamiento">
    ...
    <div>
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation"><a href="#detallealmacenamiento" aria-controls="detallealmacenamiento" role="tab" data-toggle="tab">Almacenamiento productos <span class="badge"><?= count($detalle) ?></span></a></li>
        </ul>
                            ...
                            <table class="table table-bordered table-hover">
                                <thead>
                                    <tr style="font-size: 90%;">
                                        ...
                                        <th scope="col"  style='background-color:#B9D5CE;'>Nombre rack</th> 
                                        <th scope="col"  style='background-color:#B9D5CE;'>Posicion derecha</th>  
                                        <th scope="col"  style='background-color:#B9D5CE;'>Posicion izquierda</th>  
