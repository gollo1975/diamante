...
//Modelos...
$this->title = 'MOVER POSICIONES (ALMACENAMIENTO)';
...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute("almacenamiento-producto/mover_posiciones"),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="filtro" style="display:block">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute("almacenamiento-producto/mover_posiciones") ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
