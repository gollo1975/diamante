...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        //Logo
       $this->SetXY(43, 10);
         $this->Image('dist/images/logos/logoempresa.png', 10, 10, 30, 28);
        //Encabezado
        ...
        $this->Cell(60, 5, utf8_decode($config->razon_social_completa), 0, 0, 'L', 1);
        ...
        $this->Cell(20, 5, utf8_decode("Nit:"), 0, 0, 'l', 1);
         $this->SetFont('Arial', '', 7);
        $this->Cell(60, 5, utf8_decode($config->nit_empresa." - ".$config->dv), 0, 0, 'L', 1);
       
        //FIN
        $this->SetXY(53, 17);
        $this->SetFont('Arial', 'B', 8);
        $this->Cell(20, 5, utf8_decode("Direccion:"), 0, 0, 'l', 1);
         $this->SetFont('Arial', '', 7);
        $this->Cell(60, 5, utf8_decode($config->direccion), 0, 0, 'L', 1);
        ...
        $this->Cell(20, 5, utf8_decode("Telefono:"), 0, 0, 'l', 1);
         $this->SetFont('Arial', '', 7);
        $this->Cell(60, 5, utf8_decode($config->telefono), 0, 0, 'L', 1);
        ...
        $this->Cell(20, 5, utf8_decode("Municipio:"), 0, 0, 'l', 1);
         $this->SetFont('Arial', '', 7);
        $this->Cell(60, 5, utf8_decode($config->codigoMunicipio->municipio." - ".$config->codigoDepartamento->departamento), 0, 0, 'L', 1);
       ...
       // $this->SetFillColor(200, 200, 200);
        ...
        $this->Cell(20, 5, utf8_decode("Documento:"), 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 7);
        $this->Cell(25, 5, utf8_decode($prestaciones->documento), 0, 0, 'L',1);
        $this->SetFont('Arial', 'B', 7);
        $this->Cell(25, 5, utf8_decode("Empleado:"), 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 7);
        $this->Cell(50, 5, utf8_decode($prestaciones->empleado->nombre_completo), 0, 0, 'L', 1);
        $this->SetFont('Arial', 'B', 7);
        ...
        $this->SetXY(10, 52);
        $this->SetFont('Arial', 'B', 7);
        $this->Cell(20, 5, utf8_decode("Grupo pago:"), 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 7);
        $this->Cell(25, 5, utf8_decode($prestaciones->grupoPago->grupo_pago), 0, 0, 'L',1);
        $this->SetFont('Arial', 'B', 7);
        $this->Cell(25, 5, utf8_decode("Cargo:"), 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 7);
        $this->Cell(50, 5, utf8_decode($prestaciones->contrato->cargo->nombre_cargo), 0, 0, 'L', 1);
        $this->SetFont('Arial', 'B', 7);
        ...
        $this->SetXY(10, 56);
        $this->SetFont('Arial', 'B', 7);
        $this->Cell(20, 5, utf8_decode("Ult. pago prima:"), 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 7);
        $this->Cell(25, 5, utf8_decode($prestaciones->ultimo_pago_prima), 0, 0, 'L',1);
        $this->SetFont('Arial', 'B', 7);
        ...
        $this->SetXY(10, 60);
        $this->SetFont('Arial', 'B', 7);
        $this->Cell(20, 5, utf8_decode("User name:"), 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 7);
        $this->Cell(25, 5, utf8_decode($prestaciones->usuariosistema), 0, 0, 'L',1);
        $this->SetFont('Arial', 'B', 7);
        ...
        $this->SetFont('Arial', 'B', 7);
        $this->Cell(25, 5, utf8_decode("No contrato:"), 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 7);
        ...
        $this->SetXY(10, 64);
        $this->SetFont('Arial', 'B', 7);
        $this->Cell(20, 5, utf8_decode("T. cuenta:"), 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 7);
        $this->Cell(25, 5, utf8_decode($prestaciones->empleado->tipoCuenta), 0, 0, 'L',1);
        $this->SetFont('Arial', 'B', 7);
        $this->Cell(25, 5, utf8_decode("Banco:"), 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 7);
        $this->Cell(50, 5, utf8_decode($prestaciones->empleado->banco->entidad), 0, 0, 'L', 1);
        $this->SetFont('Arial', 'B', 7);
        $this->Cell(25, 5, utf8_decode("N. cuenta:"), 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 7);
        $this->Cell(15, 5, utf8_decode($prestaciones->empleado->numero_cuenta), 0, 0, 'L', 1);
        $this->SetFont('Arial', 'B', 7);
