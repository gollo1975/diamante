...
class PDF extends FPDF {
    ...
    function Header() {
       ...
       // $this->SetFillColor(200, 200, 200);
        ...
        $this->Cell(50, 5, utf8_decode($proceso->empleado->nombre_completo), 0, 0, 'L', 0);
        //fin
        $this->SetXY(10, 67);
        $this->SetFont('Arial', 'B', 10);
        $this->Cell(50, 5, utf8_decode($proceso->empleado->tipoDocumento->tipo_documento." ".$proceso->empleado->nit_cedula), 0, 0, 'L', 0);
        //fin
        $this->SetXY(10, 75);
        $this->SetFont('Arial', '', 10);
        $this->Cell(50, 5, utf8_decode("Asunto: ACTA DE DESCARGO"), 0, 0, 'L', 0);
        //fin
       ...
       function Body($pdf, $model) {
           ...
           $cadena = utf8_decode($model->proceso_descargo); 
           $pdf->SetXY(10, 88);
           $this->SetFont('Arial', '', 10);
        ...
        $pdf->SetXY(10, 267);
        $pdf->Cell(35, 5, utf8_decode($model->empleado->tipoDocumento->tipo_documento.' '.$model->empleado->nit_cedula), 0, 0, 'L',0);
        // SEGUNDA FIRMA
        $pdf->SetXY(120, 257);
        $this->SetFont('', 'B', 9);
        ...
        $pdf->SetXY(120, 267);
        $pdf->Cell(120, 5, utf8_decode($empresa->nit_empresa."-".$empresa->dv), 0, 0, 'L',0);
        //liena
        //encabezado
        $pdf->SetXY(106, 12);
