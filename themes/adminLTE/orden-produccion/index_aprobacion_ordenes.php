            ...
            <tr style ='font-size: 90%;'>                
                ...
                <td><?= $val->cerrarOrden?></td>
                 <td style= 'width: 25px; height: 10px;'>
                    <a href="<?= Url::toRoute(["orden-produccion/view", "id" => $val->id_orden_produccion]) ?>" ><span class="glyphicon glyphicon-list" title="Permite crear las cantidades del producto, lote y codigos"></span></a>
                 </td>
