...
<div class="panel panel-success">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <?= $form->field($model, 'id_orden_compra')->widget(Select2::classname(), [
                'data' => $ordenes,
        ...
        <div class="panel-footer text-right">			
            <a href="<?= Url::toRoute("entrada-producto-terminado/index") ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-circle-arrow-left'></span> Regresar</a>
