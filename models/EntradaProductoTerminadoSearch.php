...
/**
 * EntradaProductoTerminadoSearch represents the model behind the search form of `app\models\EntradaProductoTerminado`.
 */
class EntradaProductoTerminadoSearch extends EntradaProductoTerminado
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id_entrada', 'id_proveedor', 'id_orden_compra', 'subtotal', 'impuesto', 'total_salida', 'autorizado', 'enviar_materia_prima'], 'integer'],
    ...
    {
        $query = EntradaProductoTerminado::find();
